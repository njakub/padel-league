            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2 max-w-md">
                <div
                  ...
                  style={{
                    width: `${(data.activeSeason.completedCount / data.activeSeason.totalMatches) * 100}%`,
                  }}
                />
              </div>
            </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {season.completedCount} / {season.totalMatches} matches
                      &bull; {new Date(season.createdAt).toLocaleDateString()}
                    </p>
                  </div>
                  <svg
...
export default function LeagueTabs({ sunday, wednesday }: LeagueTabsProps) {
  const [activeLeague, setActiveLeague] = useState<"sunday" | "wednesday">(
    "sunday",
  );
